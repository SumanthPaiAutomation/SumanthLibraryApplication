...
function Readers(props) {
  ...
  const handleAddPress = () => {
    setValues((oldValues) => ({
      ...
      button: 1,
      title: 'Add readers',
      description: 'Enter the reader information',
      avatar_link: ''
    }))
    setOpen(true); 
  }
    ...
    axios.post(config.base_url + '/readers', formData, {
      ...
      .then((result) => {
        if(result.data.error){
          ...
          setValues((old) => ({
            ...old,
            snackbar_message: 'You are not authorized to use this function. Please contact the administrator!',
      ...
      .catch((err) => {
        setValues((old) => ({
          ...old,
          snackbar_message: ' Please enter all information of the reader',
          snackbar_variant: 'error'
        }))
        setOpenSnackbar(true);
      })
    ...
    axios.patch(config.base_url + '/readers/' + values.current_reader, formData, {
      ...
      .then((result) => {
        if(result.data.error){
          ...
          setValues((old) => ({
            ...old,
            snackbar_message: 'Edit successful',
            snackbar_variant: 'success'
          }))
          setOpen(false);
          setOpenSnackbar(true);
      ...
      .catch((err) => {
        setValues((old) => ({
          ...old,
          snackbar_message: 'An error occurred while unable to edit the reader information',
          snackbar_variant: 'error'
        }))
        setOpenSnackbar(true);
      })
    ...
    axios.delete(config.base_url + '/readers/' + values.current_reader)
      .then((result) => {
        if(result.data.error){
          ...
          setValues((old) => ({
            ...old,
            snackbar_message: 'Reader information has been deleted',
            snackbar_variant: 'success'
          }))
          setOpenSnackbar(true);
          setOpen(false);
      ...
      .catch((err) => {
        setValues((old) => ({
          ...old,
          snackbar_message: 'An error occurred while deleting the temp read information',
          snackbar_variant: 'error'
        }))
        setOpenSnackbar(true);
      })
    ...
    axios.get(config.base_url + '/readers/' + readerId)
      .then((result) => {
        ...
        setValues(oldValues => ({
          ...
          description: 'Can edit the information',
  ...
  // csv
  const headers = [
    { label: "First and last name", key: "name" },
    { label: "Avatar", key: "avatar"},
    { label: "Email", key: "email" },
    { label: "adrress", key: "address"},
    { label: "about yourself", key: "introduce"},
    { label: "createdAt", key: "createdAt"}
  ];
  
  useEffect(() => {
    document.title = "Access the reader"
    getReaderList();
}, [])
    ...
    <Paper className={classes.paper}>
                    ...
                    <GridItem xs={12} sm={12} md={8}>
                      <Card>
                        ...
                        <CardBody>
                          ...
                          <GridContainer>
                            <GridItem xs={12} sm={12} md={12}>
                              <InputLabel style={{ color: "#AAAAAA" }}>Introduce</InputLabel>
                              <CustomInput
                                labelText="A few things about you"
                                id="introduce"
                        ...
                        <CardFooter>
                          ...
                          <Button color="info" onClick={handleClose}>Closed</Button>
                        </CardFooter>
                      </Card>
                    </GridItem>
                    <GridItem xs={12} sm={12} md={4}>
      ...
      >
        ...
        <DialogContent>
          ...
          Are you sure you want to delete this  reader information?
          </DialogContentText>
        </DialogContent>
        <DialogActions>
