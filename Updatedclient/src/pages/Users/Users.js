    ...
    const handleAddUser = (e) => {
      ...
      axios.post(config.base_url + '/users', data)
        ...
        .catch((err) => {
          setValues(oldValues => ({
            ...oldValues,
            snackbar_message: 'An error occurred while adding users!',
    ...
    const handleDeleteUser = () => {
      axios.delete(config.base_url + '/users/' + values.current_userId)
        .then((result) => {
          setValues(old => ({
            ...old,
            snackbar_message: 'User information has been deleted!',
            snackbar_variant: 'success'
          }))
          handleOpenSnackbar();
          handleCloseModal();
        ...
        .catch((err) => {
          setValues(old => ({
            ...old,
            snackbar_message: 'An error occurred while deleting user information!',
            snackbar_variant: 'error'
          }))
          handleOpenSnackbar();
          handleCloseModal();
    ...
    const getUserList = () => {
        ...
        .then((result) => {
          if(result.data.error){
            ...
            setValues(old => ({
              ...old,
              snackbar_message: 'This page is for administrators only!',
              snackbar_variant: 'error'
            }))
            handleOpenSnackbar();
          } else {
              ...
              <DialogContent>
                  <Card>
                      <CardHeader color="info">
                          <h4 className={classes.cardTitleWhite}>Add admin/manager/librarian account</h4>
                          <p className={classes.cardCategoryWhite}>Please enter all information</p>
                      </CardHeader>
                      <CardBody>
                        ...
                        <Grid container spacing={3}>
                          ...
                          <FormControl component="fieldset">
                            <FormLabel component="legend">Rights to the reader data</FormLabel>
                          ...
                          <Grid item xs={12} md={6}>
                          <FormControl component="fieldset">
                            <FormLabel component="legend">Rights to book data</FormLabel>
                              <FormGroup aria-label="position" row>
                                <FormControlLabel
                          ...
                          <Grid item xs={12} md={6}>
                          <FormControl component="fieldset">
                            <FormLabel component="legend">Rights to borrow book data</FormLabel>
                              <FormGroup aria-label="position" row>
                                <FormControlLabel
                          ...
                          <Grid item xs={12} md={6}>
                          * Note: if no rights are entered, the user can only view the data.
                          </Grid>
                          </Grid>
                        </Grid>
                      </CardBody>
                      <CardFooter>
                        <Button color="info" onClick={handleAddUser}>Completed</Button>
                        <Button color="danger" onClick={handleCloseModal}>Closed</Button>
                      </CardFooter>
                  </Card>
              </DialogContent>
          </Dialog>
